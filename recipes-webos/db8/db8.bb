...
WEBOS_VERSION = "3.2.0-138_cc582dec23ee0236007db6ea9f8a5894de26de6e"
PR = "r20"
...
EXTRA_OECMAKE += "-DWEBOS_CONFIG_BUILD_TESTS:BOOL=TRUE -DWEBOS_DB8_BACKEND:STRING=leveldb -DCMAKE_SKIP_RPATH:BOOL=TRUE"
