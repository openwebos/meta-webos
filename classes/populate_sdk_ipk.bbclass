# This instance has been added to override the existing implementation in oe-core
# in order to fix problem with it referencing /var/lib instead of OPKGLIBDIR. This
# file can be removed when the oe-core layer is updated to contain
# cf0aa9c4fdae8855803e96b1922d54a2431795d3.
...
populate_sdk_ipk() {
	...
	# WEBOS: use OPKGLIBDIR instead of /var/lib
	mv ${SDK_OUTPUT}/${OPKGLIBDIR}/opkg/* ${SDK_OUTPUT}/${SDKPATHNATIVE}${localstatedir_nativesdk}/lib/opkg/
