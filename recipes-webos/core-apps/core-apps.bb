...
# Edit BUILD-<machine>/conf/local.conf to add:
#     SRCREV_pn-<component> ?= "<commit-id>"  # don't need this if we use "tag=" above
#     IMAGE_INSTALL_append = " <component>"   # note the space before the name
